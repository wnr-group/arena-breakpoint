        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col md:flex-row overflow-y-auto min-h-0">
          ...
          <div className="flex-1 p-8 space-y-6 bg-[#0a0a0a] overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              <label className="flex flex-col items-center justify-center w-full h-24 border border-2 border-[#27272a] border-dashed rounded-xl cursor-pointer bg-[#121212] hover:bg-[#161616] hover:border-primary/40 transition-all group">
            ...
            <div className="space-y-2">
              ...
              <textarea name="specs" placeholder="GPU parameters, hardware models, preloaded setups..." className="w-full rounded-md border border-[#27272a] bg-[#121212] px-3 py-2.5 text-sm text-white focus:ring-1 focus:ring-[#FFC107] focus:border-primary h-24 outline-none resize-none transition-colors" />
            </div>
          </div>
