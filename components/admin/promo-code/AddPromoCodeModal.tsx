          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="space-y-2 md:col-span-1">
              ...
              <Input 
                ...
                className="bg-[var(--background)] border-[#e4e4e7] h-12 uppercase text-xs tracking-wider font-black text-primary placeholder-zinc-700 rounded-xl focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-transparent transition-all"
              />
            </div>
