      ...
      <div className="flex items-center gap-3 md:gap-6 flex-shrink-0">
        ...
        <div className="flex items-center gap-2 md:gap-3 cursor-pointer group select-none">
          <div className="text-right transition-transform duration-300 group-hover:-translate-x-0.5 hidden md:block">
            <p className="text-sm font-bold text-white group-hover:text-[#FFC107] transition-colors leading-tight">
              Alex Mercer
            </p>
            <p className="text-[10px] text-[#a1a1aa] uppercase tracking-widest mt-0.5 leading-none">
              Arena Manager
            </p>
          </div>
