        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col md:flex-row overflow-y-auto min-h-0">
          ...
          <div className="flex-1 p-8 space-y-6 bg-[#0a0a0a] overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                {['available', 'out_of_stock', 'hidden'].map((opt) => (
                  <label key={opt} className={`flex items-center justify-center cursor-pointer rounded-lg border py-2.5 text-xs font-bold transition-all ${status === opt ? 'border-primary bg-primary/10 text-primary' : 'border-[#27272a] bg-[#121212] text-[#a1a1aa] hover:border-zinc-700'}`}>
            ...
            <div className="space-y-2">
              ...
              <textarea name="description" value={description} onChange={(e) => setDescription(e.target.value)} className="w-full rounded-md border border-[#27272a] bg-[#121212] px-3 py-2.5 text-sm text-white focus:ring-1 focus:ring-[#FFC107] focus:border-primary h-24 outline-none resize-none transition-colors" />
            </div>
          </div>
              ...
              <Card className="bg-[#0a0a0a] border-[#27272a] overflow-hidden w-full max-w-[245px] shadow-2xl transition-all duration-300">
                ...
                <div className="p-4 flex flex-col space-y-3 bg-[#0a0a0a]">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[#a1a1aa] text-[11px] flex items-center gap-1.5 truncate"><span className="w-1.5 h-1.5 rounded-full bg-primary flex-shrink-0"></span>{category}</p>
                  </div>
