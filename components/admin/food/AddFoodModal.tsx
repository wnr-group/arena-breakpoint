    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="bg-[var(--background)] border-[#e4e4e7] text-[#111115] max-w-[900px] w-[95vw] p-0 overflow-hidden shadow-2xl h-auto max-h-[90vh] flex flex-col justify-between">
        ...
        <div className="p-6 border-b border-[#e4e4e7]/70 bg-[var(--surface)] flex-shrink-0">
          <DialogTitle className="text-xl font-black tracking-tight text-[#111115]">Add New Food Item</DialogTitle>
          <p className="text-xs text-[#52525b] mt-1">Configure menu item details and check real-time layout card output syncs</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col md:flex-row overflow-y-auto min-h-0">
          ...
          <div className="flex-1 p-8 space-y-6 bg-[var(--background)] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="flex h-10 w-full rounded-md border border-[#e4e4e7] bg-[var(--surface)] px-3 text-sm focus:border-primary focus:ring-1 focus:ring-[#FFC107] outline-none text-[#111115] cursor-pointer transition-colors"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                <label className="text-[11px] font-bold text-[#52525b] uppercase tracking-wider">Available Quantity</label>
                <input
                  type="number"
                  name="quantity"
                  placeholder="10"
            ...
            <div className="space-y-2">
              <label className="text-[11px] font-bold text-[#52525b] uppercase tracking-wider">Food Visual Asset</label>
            ...
            <div className="space-y-2">
              <label className="text-[11px] font-bold text-[#52525b] uppercase tracking-wider">Availability Status</label>
            ...
            <div className="space-y-2">
              ...
              <textarea name="description" placeholder="Describe flavors, cooking styles, textures, or key details..." className="w-full rounded-md border border-[#e4e4e7] bg-[var(--surface)] px-3 py-2.5 text-sm text-[#111115] focus:ring-1 focus:ring-[#FFC107] focus:border-primary h-24 outline-none resize-none transition-colors" />
            </div>
          </div>
          ...
          <div className="w-full md:w-[350px] bg-[var(--surface)] border-l border-[#e4e4e7]/70 p-6 flex flex-col justify-start space-y-6 flex-shrink-0 overflow-hidden select-none h-full md:sticky md:top-0">
            <div className="w-full text-center md:text-left flex-shrink-0">
              <p className="text-[11px] font-bold text-[#52525b] uppercase tracking-wider">Card Display Preview</p>
            </div>
              ...
              <Card className="bg-[var(--background)] border-[#e4e4e7] overflow-hidden w-full max-w-[245px] shadow-2xl transition-all duration-300">
                ...
                <div className="p-4 flex flex-col space-y-3 bg-[var(--background)]">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[#52525b] text-[11px] flex items-center gap-1.5 truncate"><span className="w-1.5 h-1.5 rounded-full bg-primary flex-shrink-0"></span>{previewCategory}</p>
                  </div>
            ...
            <div className="w-full flex justify-end gap-3 pt-6 border-t border-[#e4e4e7]/40 flex-shrink-0 mt-auto">
              <Button type="button" variant="ghost" className="text-[#52525b] hover:bg-[#e4e4e7] hover:text-[#111115] transition-colors text-xs font-semibold" onClick={() => setOpen(false)}>Cancel</Button>
