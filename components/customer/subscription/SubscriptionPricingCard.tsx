...
// // 1. The interface matching your database output
...
// // 2. The interface for the mapped data the UI actually renders
// interface UIPlan {
//   id: number;
//   category: string;
//   title: string;
...
//         const formattedPlans: UIPlan[] = response.data
//           .filter((plan: SubscriptionPlanDB) => plan.is_active)
//           .map((plan: SubscriptionPlanDB) => ({
//             id: plan.id,
...
//             features: plan.description ? plan.description.split(',').map(f => f.trim()) : ['Standard Access'],
...
//         const defaultPlan = formattedPlans.find((p: UIPlan) => p.isPopular) || formattedPlans[0]
//         if (defaultPlan) {
//           setActiveCard(defaultPlan.id)
//         }
//       } catch (error) {
...
//   if (isLoading) {
//     return (
//       <div className="flex flex-col items-center justify-center py-24 text-yellow-500 min-h-[400px]">
//         <Loader2 className="w-10 h-10 animate-spin mb-4" />
//         <p className="text-neutral-400 text-sm font-medium">Loading plans...</p>
//       </div>
//     )
//   }
...
//   if (plans.length === 0) {
//     return (
//       <div className="text-center text-neutral-400 py-24 min-h-[400px] flex items-center justify-center">
...
//   if (isLoading) {
//     return (
//       <div className="flex flex-col items-center justify-center py-24 text-yellow-500 min-h-100">
//         <Loader2 className="w-10 h-10 animate-spin mb-4" />
//         <p className="text-neutral-400 text-sm font-medium">Loading plans...</p>
//       </div>
//     )
