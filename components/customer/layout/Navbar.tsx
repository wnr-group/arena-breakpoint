...
const NavBar = () => {
  ...
  const navLinks = [
    { name: 'Home', path: '/' },
    { name: 'Subscriptions', path: '/customer/subscription' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="shrink-0 flex items-center">
            <Link
              href="/"
              className="text-xl md:text-2xl font-black tracking-wider text-white uppercase group"
            >
              Break Point{' '}
      ...
      >
        <div className="px-4 pt-2 pb-6 space-y-4 shadow-2xl">
          ...
          <div className="flex flex-col space-y-3 pt-4 border-t border-zinc-800/50">
            ...
            <Button
              variant="outline"
              className="w-full border-yellow-500 text-yellow-500 hover:bg-yellow-500/10 hover:text-yellow-400 font-black uppercase tracking-widest rounded-full h-12 bg-transparent"
            >
              Book Slot
            </Button>
          </div>
