    ...
    <div className="w-full space-y-16 pb-12">
      ...
      >
        ...
        <div className="relative z-20 max-w-[620px] pl-6 sm:pl-12 lg:pl-16 pr-6 py-12 space-y-6 text-left">
          ...
          {/* Tagline Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#121212]/90 backdrop-blur-sm border border-zinc-800 rounded-md text-[10px] font-black tracking-widest text-primary uppercase animate-in slide-in-from-top-4 fade-in duration-500 ease-out">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight leading-[1.02] text-white animate-in slide-in-from-left-6 fade-in duration-700 delay-100 fill-mode-both">
            LEVEL UP YOUR <br />
            <span className="text-primary drop-shadow-[0_0_35px_rgba(255,193,7,0.2)] animate-pulse duration-3000">GAMING EXPERIENCE</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-3 animate-in slide-in-from-bottom-4 fade-in duration-500 delay-300 fill-mode-both">
            <Link href="/booking">
              <Button className="bg-primary hover:bg-primary-hover text-black font-black uppercase text-xs h-12 px-6 rounded-md tracking-wider flex items-center gap-2 shadow-xl transition-all hover:scale-102 active:scale-98 hover:shadow-primary/10 hover:shadow-2xl">
          ...
          <div className="inline-flex items-center gap-3 bg-black/60 backdrop-blur-sm border border-zinc-900 rounded-lg p-2.5 pr-4 text-[11px] font-bold text-zinc-400 animate-in fade-in duration-700 delay-500 fill-mode-both">
            <span className="text-[8px] font-black uppercase bg-primary/10 text-primary px-2 py-1 border border-primary/20 rounded animate-pulse">GOLD TIER</span>
      ...
      <div className="space-y-8 pt-6 border-t border-zinc-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-base font-black text-white uppercase tracking-tight mt-2.5 group-hover:text-primary transition-colors">PlayStation 5</h3>
                </div>
                <Tv className="h-4 w-4 text-zinc-700 group-hover:text-primary group-hover:rotate-3 transition-all" />
              </div>
          ...
          <Card className="bg-[#121212] border border-primary p-6 rounded-xl flex flex-col justify-between shadow-2xl relative group hover:-translate-y-1 duration-300 shadow-primary/5 animate-in slide-in-from-bottom-8 fade-in duration-500 delay-400 fill-mode-both">
            <div className="absolute top-0 right-4 bg-primary text-black text-[8px] font-black uppercase px-2 py-0.5 rounded-b tracking-widest animate-bounce duration-2000 mt-0">
              BEST VALUE
            </div>
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <div>
                  <span className="text-[8px] font-black uppercase bg-primary/10 text-primary border border-primary/20 px-2 py-0.5 rounded-sm tracking-wider">ULTIMATE Rigs</span>
                  <h3 className="text-base font-black text-white uppercase tracking-tight mt-2.5">Gaming PC</h3>
                </div>
                <Monitor className="h-4 w-4 text-primary group-hover:scale-110 transition-transform" />
              </div>
              <p className="text-3xl font-black text-primary drop-shadow-[0_0_15px_rgba(255,193,7,0.1)]">₹ 350<span className="text-[11px] text-zinc-600 font-bold"> /hr</span></p>
            ...
            <div className="pt-6">
              <Link href="/booking" className="block">
                <Button className="w-full bg-primary hover:bg-primary-hover text-black text-xs font-black uppercase py-4 rounded-md shadow-md transition-all active:scale-98 hover:shadow-primary/20 hover:shadow-lg">
                  BOOK STATION
                </Button>
              </Link>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-base font-black text-white uppercase tracking-tight mt-2.5 group-hover:text-primary transition-colors">Xbox Series X</h3>
                </div>
                <Gamepad2 className="h-4 w-4 text-zinc-700 group-hover:text-primary group-hover:-rotate-3 transition-all" />
              </div>
              <p className="text-3xl font-black text-white">₹ 300<span className="text-[11px] text-zinc-500 font-bold"> /hr</span></p>
              <ul className="space-y-2 text-[11px] text-zinc-400 font-semibold border-t border-zinc-900 pt-4">
