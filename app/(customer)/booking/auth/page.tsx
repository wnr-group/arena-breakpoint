    ...
    return (
      <div className="w-full max-w-xl mx-auto py-4 px-2 animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="w-full max-w-xs mx-auto flex items-center justify-between pb-8 select-none">
          <div className="flex flex-col items-center gap-1"><div className="w-5 h-5 rounded-full bg-[#e4e4e7] border border-[#e4e4e7] text-[#52525b] font-bold text-[9px] flex items-center justify-center">1</div><span className="text-[8px] font-black uppercase text-[#52525b] tracking-wider">Time Slot</span></div>
          ...
          <div className="flex flex-col items-center gap-1"><div className="w-5 h-5 rounded-full bg-[#e4e4e7] text-[#52525b] font-bold text-[9px] flex items-center justify-center border border-[#e4e4e7]">3</div><span className="text-[8px] font-black uppercase text-[#52525b] tracking-wider">Payment</span></div>
        </div>
        ...
        <Card className="bg-[#f4f4f5] border border-[#e4e4e7] p-6 shadow-2xl rounded-2xl space-y-6 glow-box-hover">
          ...
          <div className="border-b border-[#e4e4e7] pb-4 space-y-1">
            ...
            <p className="text-xs text-[#52525b] font-medium">Enter your mobile number to continue with booking.</p>
          </div>

          {/* Live Active Hold Summary Strip */}
          <div className="bg-[#f4f4f5] p-3 rounded-xl border border-[#e4e4e7] grid grid-cols-2 gap-2 text-xs glow-box-hover">
            <div className="space-y-0.5"><span className="text-[8px] font-black text-[#52525b] uppercase block">Selected Setup</span><span className="text-[#111115] font-black text-left break-words leading-tight max-w-[200px] block uppercase">{deviceTypeName || "PLAYSTATION 5"}</span></div>
            <div className="space-y-0.5 text-right"><span className="text-[8px] font-black text-[#52525b] uppercase block">Reserved Slot</span><span className="text-primary text-[12px] text-right font-black">{selectedSlot || "Pending Hold"}</span></div>
          </div>
          ...
          <form onSubmit={handlePhoneSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="bg-[#f4f4f5] border-[#e4e4e7] h-12 pl-12 text-sm text-[#111115] focus-visible:ring-primary font-mono tracking-wide"
                />
              </div>
            </div>
            ...
            <div className="pt-4 space-y-2">
              ...
              <Button type="button" onClick={() => { dispatch(releaseSlotHold()); router.back(); }} variant="ghost" className="w-full border border-[#e4e4e7] text-[#52525b] hover:text-[#3f3f46] font-bold uppercase text-[11px] h-11 rounded-xl">
      ...
      <div className="w-full max-w-xl mx-auto py-4 px-2 animate-in fade-in duration-300">
        ...
        <Card className="bg-[#f4f4f5] border border-[#e4e4e7] p-6 shadow-2xl rounded-2xl space-y-6 glow-box-hover">
          <div className="border-b border-[#e4e4e7] pb-4 space-y-1">
            ...
            <p className="text-xs text-[#52525b] font-medium">Please provide your details to create your profile.</p>
          </div>

          <div className="bg-[#f4f4f5] p-3 rounded-xl border border-[#e4e4e7] text-xs">
            <div className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-primary" />
              <span className="text-[#52525b]">Phone Number:</span>
              <span className="text-[#111115] font-black">+91 {mobileNumber}</span>
            </div>
          </div>
          ...
          <form onSubmit={handleDetailsSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-[#f4f4f5] border-[#e4e4e7] h-12 text-sm text-[#111115] focus-visible:ring-primary"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-[#f4f4f5] border-[#e4e4e7] h-12 text-sm text-[#111115] font-mono tracking-wider focus-visible:ring-primary rounded-xl"
              />
            </div>
  ...
  if (step === "summary") {
    return (
      <div className="w-full max-w-2xl mx-auto py-4 px-2 animate-in fade-in duration-300">
        ...
        <Card className="bg-[#f4f4f5] border border-[#e4e4e7] p-6 shadow-2xl rounded-2xl space-y-6 glow-box-hover">
          <div className="border-b border-[#e4e4e7] pb-4 space-y-1">
            <h3 className="text-lg font-black uppercase text-[#111115] tracking-tight">BOOKING SUMMARY</h3>
            <p className="text-xs text-[#52525b] font-medium">Review your booking details before confirmation.</p>
          </div>
          ...
          <div className="bg-[#f4f4f5] p-4 rounded-xl border border-[#e4e4e7] space-y-3 glow-box-hover">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between"><span className="text-[#52525b]">Customer:</span> <span className="text-[#111115] font-bold">{customerName || existingCustomerData?.name}</span></div>
              <div className="flex justify-between"><span className="text-[#52525b]">Phone:</span> <span className="text-primary font-bold">+91 {mobileNumber}</span></div>
              <div className="flex justify-between"><span className="text-[#52525b]">Email:</span> <span className="text-[#111115] font-bold truncate ml-4">{customerEmail || existingCustomerData?.email}</span></div>
              <div className="flex justify-between"><span className="text-[#52525b]">DOB:</span> <span className="text-[#111115] font-bold">{customerDob}</span></div>
            </div>
          </div>

          {/* Booking Details */}
          <div className="bg-[#f4f4f5] p-4 rounded-xl border border-[#e4e4e7] space-y-3 glow-box-hover">
            <h4 className="text-[10px] font-black text-[#52525b] uppercase tracking-wider mb-2">Booking Details</h4>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between"><span className="text-[#52525b]">Device:</span> <span className="text-[#111115] font-bold text-right">{deviceTypeName}</span></div>
              <div className="flex justify-between"><span className="text-[#52525b]">Date:</span> <span className="text-[#111115] font-bold">{selectedDate ? `${new Date(selectedDate).toLocaleDateString()}, ${new Date(selectedDate).toLocaleDateString('en-US', { weekday: 'short' })}` : "--"}</span></div>
              <div className="flex justify-between"><span className="text-[#52525b]">Time Slot:</span> <span className="text-primary font-bold">{selectedSlot}</span></div>
              <div className="flex justify-between"><span className="text-[#52525b]">Duration:</span> <span className="text-[#111115] font-bold">{selectedDurationLabel}</span></div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-primary/10 via-amber-500/10 to-primary/10 p-4 rounded-xl border border-primary/30 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#3f3f46]">You're getting {bookingState.subscriptionDiscountPercentage}% off on this booking!</p>
                </div>
              </div>
            </div>
          )}
          ...
          {/* Promo Code Section */}
          <div className="bg-[#f4f4f5] p-4 rounded-xl border border-[#e4e4e7] space-y-3">
            <div className="flex items-center gap-2">
              <Tag className="h-4 w-4 text-[#52525b]" />
              <h4 className="text-[10px] font-black text-[#52525b] uppercase tracking-wider">
                Have a Promo Code?
              </h4>
            </div>
            <div className="flex gap-2">
              <Input
                ...
                className="bg-white border-[#e4e4e7] text-[#111115] uppercase font-mono text-sm"
          ...
          {/* Pricing Details */}
          <div className="bg-[#f4f4f5] p-4 rounded-xl border border-[#e4e4e7] space-y-3 glow-box-strong">
            <h4 className="text-[10px] font-black text-[#52525b] uppercase tracking-wider mb-2">Price Breakdown</h4>
            <div className="space-y-2 text-sm">
              {(() => {
                ...
                return (
                  <>
                    <div className="flex justify-between">
                      <span className="text-[#52525b]">Device Booking ({durationInHours}h × ₹{hourlyRate}):</span>
                      <span className="text-[#111115]">₹{deviceCharges.toFixed(2)}</span>
                    </div>

                    {playerCount > includedPlayers && (
                      <div className="flex justify-between">
                        <span className="text-[#52525b]">Extra Players ({playerCount - includedPlayers} × ₹{extraPlayerCharge} × {durationInHours}h):</span>
                        <span className="text-[#111115]">₹{extraPlayerCharges.toFixed(2)}</span>
                      </div>
                    )}

                    {addons.length > 0 && (
                      <div className="flex justify-between">
                        <span className="text-[#52525b]">Add-ons:</span>
                        <span className="text-[#111115]">₹{addonsTotal.toFixed(2)}</span>
                      </div>
                    )}

                    <div className="flex justify-between border-t border-[#e4e4e7] pt-2">
                      <span className="text-[#3f3f46] font-bold">Subtotal:</span>
                      <span className="text-[#111115] font-bold">₹{calculatedSubtotal.toFixed(2)}</span>
                    </div>
                    ...
                    <div className="border-t border-[#e4e4e7] pt-2 flex justify-between font-black text-base">
                      <span className="text-[#111115]">Total Amount:</span>
      ...
      <div className="w-full max-w-2xl mx-auto py-4 px-2 animate-in fade-in duration-500">
        <Card className="bg-[#f4f4f5] border border-green-500/20 p-8 shadow-2xl rounded-2xl space-y-6 glow-box-strong">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-black uppercase text-[#111115] tracking-tight">BOOKING CONFIRMED!</h3>
              <p className="text-sm text-[#3f3f46]">Your slot has been successfully reserved.</p>
            </div>
          </div>
          ...
          <div className="bg-[#f4f4f5] p-6 rounded-xl border border-[#e4e4e7] space-y-4 glow-box-strong">
            ...
            <div className="text-center">
              <p className="text-xs text-[#52525b] mb-1">Booking Number</p>
          ...
          <div className="bg-[#f4f4f5] p-4 rounded-xl border border-[#e4e4e7] space-y-3 text-sm glow-box-hover">
            <h4 className="text-[10px] font-black text-[#52525b] uppercase">Booking Details</h4>
            <div className="flex justify-between"><span className="text-[#52525b]">Customer:</span> <span className="text-[#111115] font-bold">{customerName || existingCustomerData?.name}</span></div>
            <div className="flex justify-between"><span className="text-[#52525b]">Phone:</span> <span className="text-primary font-bold">+91 {mobileNumber}</span></div>
            <div className="flex justify-between"><span className="text-[#52525b]">Device:</span> <span className="text-[#111115] font-bold">{deviceTypeName}</span></div>
            <div className="flex justify-between"><span className="text-[#52525b]">Date:</span> <span className="text-[#111115] font-bold">{selectedDate ? new Date(selectedDate).toLocaleDateString() : "--"}</span></div>
            <div className="flex justify-between"><span className="text-[#52525b]">Time:</span> <span className="text-primary font-bold">{selectedSlot}</span></div>
            <div className="flex justify-between"><span className="text-[#52525b]">Duration:</span> <span className="text-[#111115] font-bold">{selectedDurationLabel}</span></div>
            <div className="flex justify-between"><span className="text-[#52525b]">Players:</span> <span className="text-[#111115] font-bold">{playerCount}</span></div>
            {playerCount > includedPlayers && (
              <div className="flex justify-between text-xs"><span className="text-[#52525b]">Extra Players:</span> <span className="text-[#3f3f46]">+₹{((playerCount - includedPlayers) * extraPlayerCharge * ((selectedDuration || 60) / 60)).toFixed(2)}</span></div>
            )}
            {bookingState.subscriptionDiscount > 0 && (
            ...
            <div className="flex justify-between border-t border-[#e4e4e7] pt-2 font-black"><span className="text-[#52525b]">Amount Paid:</span> <span className="text-[#111115]">₹{total}</span></div>
          </div>
          ...
          <div className="space-y-2 pt-2">
            ...
            }} variant="ghost" className="w-full border-2 border-primary text-[#3f3f46] hover:text-[#3f3f46] font-bold uppercase text-[11px] h-11 rounded-xl">
              VIEW MY BOOKINGS
            </Button>
            <Button onClick={() => {
              dispatch(resetBooking());
              router.push("/");
            }} variant="ghost" className="w-full text-[#3f3f46] border border-[#e4e4e7] hover:text-[#3f3f46] font-bold uppercase text-[11px] h-10 rounded-xl">
              BACK TO HOME
            </Button>
          </div>
